...
import expect from "@testing-library/react" // You can use any testing library
...
describe('async actions', () => {
    ...
    it('Creates GET_RECIPE_SUCCESS when fetching for random meal', () => {
        const id = '52965';
        const expectedMeal = Promise.resolve({
            meals: [{
                "idMeal": "52965",
                ...
                "strIngredient10": "", "strIngredient11": "", "strIngredient12": "", "strIngredient13": "", "strIngredient14": "", "strIngredient15": "", "strIngredient16": "", "strIngredient17": "", "strIngredient18": "", "strIngredient19": "", "strIngredient20": "",
        ...
        fetchMock
            .getOnce(`www.themealdb.com/api/json/v1/1/lookup.php?i=${id}`)
        const expectedActions = [
            { type: types.GET_RECIPE_SUCCESS, body: expectedMeal },
        ]
        const store = mockStore({ isLoggedIn: false, user: null })
        return store.dispatch(action.getRecipeAction()).then(() => {
